...
function LineTwo({ className, animationEnd }: LineProps) {
    return (
        ...
        >
            ...
            <Cylinder text="Welcome to " width="w-64 md:w-[400px]" />
            <Circle bgColor="bg-green-500" borderRadius="rounded-t-full rounded-bl-full" />
            <Circle bgColor="bg-green-500" />
            <Cylinder bgColor="bg-purple-700" />
        </div>
...
function LineThree({ className, animationEnd }: LineProps) {
    return (
        ...
        >
            ...
            <Circle bgColor="bg-blue-400" /> <Cylinder text="ERROR 404 Club" width="w-64 md:w-[600px]" />
...
function LineFour({ className, animationEnd }: LineProps) {
    return (
        ...
        >
            ...
            <Cylinder text="Student-run Organization" width="w-96 md:w-[800px]" />
...
export default function SlackIntro({
    ...
    return (
        <div
            className={cn(
                "flex flex-col md:mt-10 items-center w-full justify-center gap-1 overflow-hidden  py-4 md:gap-3",
            )}
        >
